            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Новые пользователи должны подтвердить email
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-gray-900">
                    Автоматическое одобрение организаторов
                  </h3>
                  <p className="text-sm text-gray-500">
                    Новые организаторы одобряются автоматически
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setGeneralSettings({
                        ...generalSettings,
                        autoApproveOrganizers: e.target.checked,
                      })
                    }
                    className="sr-only peer"
                  />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSecuritySettings({
                      ...securitySettings,
                      blockDuration: parseInt(e.target.value) || 30,
                    })
                  }
                  min="5"
                  max="1440"
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Требовать подтверждение через приложение
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
          ...
          <div className="sticky top-4 space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
              ...
              <div className="space-y-2 text-sm text-amber-800">
                <p>
                  • Изменения настроек безопасности вступают в силу немедленно
                </p>
                <p>
                  • Рекомендуется создавать резервные копии перед изменениями
                </p>
                <p>
                  • Неправильные настройки email могут нарушить работу
                  уведомлений
                </p>
              </div>
            </div>
