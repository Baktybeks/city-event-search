// components/events/CompactEventStatus.tsx
"use client";
...
export function CompactEventStatus({ event }: CompactEventStatusProps) {
            ...
            {event.status !== EventStatus.COMPLETED && (
              ...
              >
                {event.featured ? (
                  ...
                  <>
                    <Star className="h-4 w-4 text-yellow-500" />В рекомендуемые
                  </>
                )}
              </button>
            )}
